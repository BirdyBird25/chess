...
public class Square extends JComponent {
    ...
    private SuperKing occupyingPiece;
    ...
    public SuperKing getOccupyingPiece() {
    ...
    public void put(SuperKing p) {
        this.occupyingPiece = p;
    }
    
    public SuperKing removePiece() {
        SuperKing p = this.occupyingPiece;
